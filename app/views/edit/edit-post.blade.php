	...
	<div class="panel panel-default">
	  <div class="panel-body">
	    <div style="padding:10px;">
	        <h4 style="font-size:32px;padding-bottom:10px;margin-bottom:15px;border-bottom:1px solid #eaeaea">
	        ...
	        <p style="font-size:17px;line-height:24px;padding-bottom:15px">
